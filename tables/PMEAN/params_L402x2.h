...
c---T42_L40 run at full resolution and L37 or L40
c     character*10, parameter ::  MODEL = 'EC_T42_L40'
c---1x1_L40 run at full resolution and L37 or L40
      character*10, parameter ::  MODEL = 'EC_1x1_L40'
c---T42_L60 run at full resolution and L57 or L60
...
c     integer, parameter :: IPARW=128, JPARW=64,  LPARW=40   !T42L40 EC grid
      integer, parameter :: IPARW=360, JPARW=180, LPARW=40   !1X1L40 EC grid
...
c     integer, parameter :: NSPGT = 3-(IPARW/300)
c     integer, parameter :: NTRUNW = (IPARW-1)/NSPGT  ! T42
      integer, parameter :: NTRUNW = 319              ! 1x1
...
c     integer, parameter :: FFTPTS = IPARW+10     ! T42
      integer, parameter :: NRFFT = 4             ! 1X1
      integer, parameter :: FFTPTS = 3*(NTRUNW+2) ! 1X1
...
c---resolution of CTM run (consistent with met fields and degrad)
...
c     integer, parameter :: IPAR=128, JPAR=64, LPAR=57   !**  ECT42L60 grid
      integer, parameter :: IPAR=180, JPAR=90,  LPAR=37  !**  EC2x2 grid
      integer, parameter :: LWEPAR=LPAR, LWDPAR=30, LDPAR=1
...
c     integer, parameter ::  MPIPAR=18, MPJPAR=9  !** EC1x1 grid
      integer, parameter ::  MPIPAR=10, MPJPAR=5  !** EC2x2 grid
