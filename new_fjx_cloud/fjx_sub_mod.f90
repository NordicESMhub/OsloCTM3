...
!
      USE CMN_FJX_MOD
      USE CMN_PARAMETERS, only: CPI180, C2PI

      IMPLICIT NONE
!
! !PUBLIC SUBROUTINES:
!
      PUBLIC  :: SOLAR_JX, ACLIM_FJX, JP_ATM0, PHOTO_JX
...
!      write(6,'(2a)') &
!      ' absorb solar: W/m2/kyr K/day by wavel 10000=Fsolar', &
!      '  [NB: values <0 = numerical error w/clouds or SZA>90, colm OK]'
!      do L = LU,1,-1
!          SWHEAT = 0.d0
!        do K=NW1,NW2
...
!        enddo
!          SKPERD = &
!            SWHEAT*86400.d0/(1005.d0*(PPP(L)-PPP(L+1))*100.d0/9.8d0)
!        write(6,'(i9,2x,2f8.4,18i8)') &
!            L,SWHEAT,SKPERD,(RATIO(K),K=NW2,NW1,-1)
!      enddo
       write(6,'(a)')
...
!   this combination of wvelengths works fine in stratosphere wwith O3
!   attenuaition
